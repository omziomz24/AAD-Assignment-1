...
Note that ID is just for labellng purposes and it is not a relevant predictor, so we don't care about the correlation between ID and other variables and hence do not include it in our correlation matrix plot. \ 
...
The R-squared and adjusted R-squared both equal to 0.617 when corrected to 3 decimal places. This means that 61.7% of the variation in the predictors are useful in explaining the variation in the response variable (medianHouseValue). \ 
