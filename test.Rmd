...
When inspecting the orginal data, we observe that there are some missing values (NA's) in aveBedrooms. We delete these rows that contains NA's for simplicity. 
```{r }
...
Let's first inspect the distribution of the response variable, medianHouseValue. \
