...
lm.fit <- lm(medianHouseValue~poly(medianIncome,3)+longitude+latitude+longitude:latitude +bedroomsPerRoom +oceanProximity +housingMedianAge,data = data_unlev) # change between data and data_unlev
summary(lm.fit)
plot(lm.fit)
deviance(lm.fit)
...
# play around more, also can do ridge, lasso and pcr maybe?
```
